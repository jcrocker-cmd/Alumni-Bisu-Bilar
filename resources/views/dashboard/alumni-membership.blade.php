...
@section('content')
  ...
  <div class="sidebar" id="side_nav">
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/alumni-membership" class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list" style="margin-right: 10px;"></i>   Alumni Membership <span style="margin-left: 30px;">Report</span></a></li>
