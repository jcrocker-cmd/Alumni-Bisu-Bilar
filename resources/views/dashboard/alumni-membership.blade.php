...
@section('content')
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/alumni-membership" class="text-decoration-none px-3 py-2 d-block"><i class="fal fa-list" style="margin-right: 12px;"></i>   Alumni Membership Report</a></li>
      @endrole
