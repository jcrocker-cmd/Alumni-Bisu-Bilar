...
@section('content')
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/alumni-id" class="text-decoration-none px-3 py-2 d-block"><i class="far fa-portrait" style="margin-right: 15px;"></i>   Alumni ID Production <span style="margin-left: 32px;">Report</span></a></li>
