...
@section('content')
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      <li class="active"><a href="/user-roles" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-user" style="margin-right: 14px;"></i>   Users Roles</a></li>
      @endrole
    </ul>
...
@push('scripts')
    ...
    <script src="/js/db-validation-user.js"></script>
    <script src="/js/db-validation-user-edit.js"></script>
    <script src="/js/ajax-user-view.js"></script>
    <script src="/js/ajax-user-edit.js"></script>
@endpush
