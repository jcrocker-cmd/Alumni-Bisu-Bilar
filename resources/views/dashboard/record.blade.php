...
@section('content')
    ...
    <ul class ="list-unstyled px-2 ">
      ...
      @role(['ID Staff','Super-Admin', 'Admin','Secretary'])
      <li class="active"><a href="/record-of-alumni" class="text-decoration-none px-3 py-2 d-block"><i class="far fa-book-alt" style="margin-right: 13px;"></i>   Record for the Information <span style="margin-left: 30px;">of Alumni Students</span></a></li>
      @endrole
  ...
  <div id="dashboard-content">
    ...
    @include('dashboard.components.record')
</div>
...
@push('scripts')
    ...
    <script src="/js/chart-student.js"></script> --}}
    <script src="/js/ajax-record-view.js"></script>
@endpush
