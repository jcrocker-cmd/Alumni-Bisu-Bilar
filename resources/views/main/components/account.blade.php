...
@if (session('accountstatus'))
  <h6 class="alert alert-success" id="myAlert">{{ session('accountstatus') }}</h6>
@endif

@if (session('successpassword'))
  <h6 class="alert alert-success" id="myAlert">{{ session('successpassword') }}</h6>
@endif
...
@endif
            ...
            <div class="settings-col-1 ">
                ...
                <div class="group">
                    ...
                    <div class="mb-2" style="width: 100%;">
                        ...
                        <input type="text"  name="course" class="form-control bg-white" id="exampleFormControlInput1" placeholder="Edit Address" value="{{ Auth::user()->course }}">
                    </div>
                </div>
    ...
    <div class="settings-wrapper-2 px-3 py-5">
        <div class="settings-col-2">
            <form enctype="multipart/form-data" action="/change-student-pp" method="post">
            @csrf
            @method('put')
            <div class="addphoto">
                ...
                @else
                    <img src="/images/default-user.webp" id="change-img-add" style="object-fit: cover;">
                @endif
            </div>
    ...
    <div class="settings-wrapper bg-white px-3 py-4 mt-4">
        ...
        <form action="/change-student-password" method="post" class="py-2">
        @csrf
        @method('put')
